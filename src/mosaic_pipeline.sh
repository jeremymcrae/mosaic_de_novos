...
samtools mpileup -gDf ${reference} father.bam > father.bcf
samtools mpileup -gDf ${reference} mother.bam > mother.bcf
...
/nfs/team29/aw15/samtoolsMod/samtools mpileup -p0.25 -gDf ${reference} child.bam > child.bcf
